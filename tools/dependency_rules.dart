...
class DependencyAnalyzer {
  static const List<DependencyRule> _rules = [
    ...
    DependencyRule(
      ...
      description: 'Cross-feature module dependency not allowed (features/moduleA should not depend on features/moduleB)',
    ...
    DependencyRule(
      ...
      description: 'Direct import of private implementation files not allowed (_impl, _mock, _test, _internal, _private)',
        ...
        for (final rule in _rules) {
          ...
          if (regex.hasMatch(line)) {
            ...
            if (_isContextualViolation(line, filePath, fileModule, rule)) {
              violations.add(DependencyViolation(
                file: filePath,
                import: line.trim(),
                rule: rule,
                line: i + 1,
