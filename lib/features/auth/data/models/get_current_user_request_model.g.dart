...
_GetCurrentUserRequestModel _$GetCurrentUserRequestModelFromJson(Map json) =>
    $checkedCreate('_GetCurrentUserRequestModel', json, ($checkedConvert) {
      final val = _GetCurrentUserRequestModel(userId: $checkedConvert('userId', (v) => v as String));
      return val;
    });

Map<String, dynamic> _$GetCurrentUserRequestModelToJson(_GetCurrentUserRequestModel instance) =>
