...
mixin _$ChangePasswordState {
 ...
 String get oldPassword; String get newPassword; String get confirmPassword; String? get oldPasswordError; String? get newPasswordError; String? get confirmPasswordError;
...
@override
int get hashCode => Object.hash(runtimeType,oldPassword,newPassword,confirmPassword,oldPasswordError,newPasswordError,confirmPasswordError);

@override
String toString() {
  return 'ChangePasswordState(oldPassword: $oldPassword, newPassword: $newPassword, confirmPassword: $confirmPassword, oldPasswordError: $oldPasswordError, newPasswordError: $newPasswordError, confirmPasswordError: $confirmPasswordError)';
}
...
@useResult
$Res call({
 String oldPassword, String newPassword, String confirmPassword, String? oldPasswordError, String? newPasswordError, String? confirmPasswordError
});
...
/// Create a copy of ChangePasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? oldPassword = null,Object? newPassword = null,Object? confirmPassword = null,Object? oldPasswordError = freezed,Object? newPasswordError = freezed,Object? confirmPasswordError = freezed,}) {
...
as String,oldPasswordError: freezed == oldPasswordError ? _self.oldPasswordError : oldPasswordError // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String oldPassword,  String newPassword,  String confirmPassword,  String? oldPasswordError,  String? newPasswordError,  String? confirmPasswordError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChangePasswordState() when $default != null:
return $default(_that.oldPassword,_that.newPassword,_that.confirmPassword,_that.oldPasswordError,_that.newPasswordError,_that.confirmPasswordError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String oldPassword,  String newPassword,  String confirmPassword,  String? oldPasswordError,  String? newPasswordError,  String? confirmPasswordError)  $default,) {final _that = this;
switch (_that) {
case _ChangePasswordState():
return $default(_that.oldPassword,_that.newPassword,_that.confirmPassword,_that.oldPasswordError,_that.newPasswordError,_that.confirmPasswordError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String oldPassword,  String newPassword,  String confirmPassword,  String? oldPasswordError,  String? newPasswordError,  String? confirmPasswordError)?  $default,) {final _that = this;
switch (_that) {
case _ChangePasswordState() when $default != null:
return $default(_that.oldPassword,_that.newPassword,_that.confirmPassword,_that.oldPasswordError,_that.newPasswordError,_that.confirmPasswordError);case _:
  return null;
...
class _ChangePasswordState extends ChangePasswordState {
  const _ChangePasswordState({this.oldPassword = '', this.newPassword = '', this.confirmPassword = '', this.oldPasswordError, this.newPasswordError, this.confirmPasswordError}): super._();
...
@override final  String? oldPasswordError;
...
/// Create a copy of ChangePasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? oldPassword = null,Object? newPassword = null,Object? confirmPassword = null,Object? oldPasswordError = freezed,Object? newPasswordError = freezed,Object? confirmPasswordError = freezed,}) {
