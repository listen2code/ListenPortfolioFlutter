...
part of 'privacy_policy_intent.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PrivacyPolicyIntent);
}
...
/// @nodoc
class $PrivacyPolicyIntentCopyWith<$Res>  {
$PrivacyPolicyIntentCopyWith(PrivacyPolicyIntent _, $Res Function(PrivacyPolicyIntent) __);
}


/// Adds pattern-matching-related methods to [PrivacyPolicyIntent].
extension PrivacyPolicyIntentPatterns on PrivacyPolicyIntent {
...
class _Refresh extends PrivacyPolicyIntent {
...
@override
String toString() {
  return 'PrivacyPolicyIntent.refresh()';
}
