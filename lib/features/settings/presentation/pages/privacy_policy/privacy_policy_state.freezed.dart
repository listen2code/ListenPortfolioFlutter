...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PrivacyPolicyState&&(identical(other.lastUpdated, lastUpdated) || other.lastUpdated == lastUpdated));
}
...
@override
String toString() {
  return 'PrivacyPolicyState(lastUpdated: $lastUpdated)';
}
...
/// Create a copy of PrivacyPolicyState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lastUpdated = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String lastUpdated)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PrivacyPolicyState() when $default != null:
return $default(_that.lastUpdated);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String lastUpdated)  $default,) {final _that = this;
switch (_that) {
case _PrivacyPolicyState():
return $default(_that.lastUpdated);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String lastUpdated)?  $default,) {final _that = this;
switch (_that) {
case _PrivacyPolicyState() when $default != null:
return $default(_that.lastUpdated);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PrivacyPolicyState&&(identical(other.lastUpdated, lastUpdated) || other.lastUpdated == lastUpdated));
}
...
/// Create a copy of PrivacyPolicyState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lastUpdated = null,}) {
