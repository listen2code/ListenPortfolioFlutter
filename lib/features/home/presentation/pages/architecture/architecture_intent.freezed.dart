...
class _LaunchURL extends ArchitectureIntent {
  const _LaunchURL(this.url): super._();
  

 final  String url;

/// Create a copy of ArchitectureIntent
...
@override
String toString() {
  return 'ArchitectureIntent.launchURL(url: $url)';
}
...
/// @nodoc
abstract mixin class _$LaunchURLCopyWith<$Res> implements $ArchitectureIntentCopyWith<$Res> {
