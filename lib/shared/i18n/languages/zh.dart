...
final Map<String, String> zh = {
  ...
  I18nKeys.fontFamily: '界面字体',
  I18nKeys.fontFamilySystem: '系统默认 (System Default)',
  I18nKeys.fontFamilySansSerif: '黑体 / 无衬线 (Sans-Serif)',
  I18nKeys.fontFamilySerif: '宋体 / 衬线体 (Serif·SongTi)',
  I18nKeys.fontFamilyKaiti: '楷体 / 书法体 (KaiTi·Calligraphy)',
  I18nKeys.fontFamilyRounded: '圆体 / 柔和体 (Rounded·YuanTi)',
  I18nKeys.fontFamilyMonospace: '等宽代码体 (Monospace)',
  I18nKeys.fontFamilyCursive: '艺术手写体 (Cursive·Handwriting)',
  ...
  I18nKeys.aboutAuthor: '关于作者',
  I18nKeys.authorResume: '作者简历',
  I18nKeys.authorProjects: '作者项目',
  I18nKeys.contactAuthor: '联系作者',
  I18nKeys.roleAuthor: '作者',
  I18nKeys.roleMember: '注册用户',
  I18nKeys.roleGuest: '访客',
  I18nKeys.cannotDeleteAuthorAccount: '作者根账号不可注销',
  I18nKeys.architecture: '架构设计',
  I18nKeys.logout: '退出登录',
  I18nKeys.logoutTips: '您确定要退出登录吗？',
  I18nKeys.hello: '你好，我是 %s',
  I18nKeys.welcomeToPortfolio: '欢迎查看 %s 的作品集',
  I18nKeys.downloadMyResume: '下载我的简历',
  I18nKeys.downloadAuthorResume: '下载作者简历',
  I18nKeys.myFeaturedProjects: '我的精选项目',
  I18nKeys.authorFeaturedProjects: '作者精选项目',
  I18nKeys.myExperienceAndSkills: '我的经历与技能',
  I18nKeys.authorExperienceAndSkills: '作者经历与技能',
  ...
  I18nKeys.pushTestTitle: '推送测试',
  I18nKeys.pushTestSubtitle: '触发前台推送通知横幅模拟',
  I18nKeys.pushTestNoticeTitle: '前台测试通知',
  I18nKeys.pushTestNoticeBody: '这是一个在前台接收的推送通知横幅模拟。',
  I18nKeys.webViewTestTitle: 'WebView 测试',
  I18nKeys.webViewTestSubtitle: '测试内置 Web 页面与 Dialog',
  I18nKeys.filterTraceId: '根据 Trace ID 筛选...',
  I18nKeys.filterNetwork: '根据 URL、状态码、Trace ID 筛选...',
  I18nKeys.urlCopied: 'URL 已复制到剪贴板',
  ...
  I18nKeys.descShorebird: 'OTA 热更新服务（支持无感后台修复与版本补丁号展示）',
  I18nKeys.descDioRetrofit: '类型安全的网络请求与拦截器',
  ...
  I18nKeys.faultInjectionPlayground: '故障注入与韧性演示',
  I18nKeys.faultInjectionSubtitle: '401 并发队列、崩溃熔断与可观测性实操演练',
  I18nKeys.faultAllCategories: '全部场景',
  I18nKeys.faultCategoryNetwork: '网络与认证',
  I18nKeys.faultCategoryStability: '稳定性与崩溃',
  I18nKeys.faultCategoryPerformance: '性能与 APM',
  I18nKeys.faultRunScenario: '开始演练',
  I18nKeys.faultRunning: '正在执行...',
  I18nKeys.faultSuccess: '执行成功',
  I18nKeys.faultRecovered: '自动恢复',
  I18nKeys.faultFailed: '未捕获/失败',
  I18nKeys.faultConsoleTitle: '实时执行控制台与 Trace 跟踪',
  I18nKeys.faultClearConsole: '清空控制台',
  I18nKeys.faultCopyTrace: '复制 Trace ID',
  I18nKeys.faultDrillTrace: '在日志浮窗中下钻 Trace',
  I18nKeys.faultTraceCopied: 'Trace ID 已复制到剪贴板',
  I18nKeys.faultExecutionDuration: '耗时: %sms',
  I18nKeys.faultStatusIdle: '空闲待命',
  I18nKeys.faultScenario401Title: '401 并发失效与静默重试队列',
  I18nKeys.faultScenario401Desc: '模拟 Token 失效并发发起 5 个受保护请求。验证 AuthInterceptor 队列拦截、1次静默刷新与 100% 自动恢复。',
  I18nKeys.faultScenario500Title: '500 服务端异常与契约错误映射',
  I18nKeys.faultScenario500Desc: '模拟服务端 500 内部异常。验证 BaseRepository.safeCall() 错误收敛、Either<Failure, T> 封包与优雅降级。',
  I18nKeys.faultScenarioTimeoutTitle: '网络连接超时与断网重试降级',
  I18nKeys.faultScenarioTimeoutDesc: '模拟网络超时与连接断开。验证 NetworkException 异常捕获、重试机制与本地缓存数据回退。',
  I18nKeys.faultScenarioMalformedTitle: '网关 HTML 畸形响应防崩溃保护',
  I18nKeys.faultScenarioMalformedDesc: '模拟反向代理返回 413/502 HTML 网页字符串。验证 BaseResponseModel 类型安全守卫，杜绝 TypeError 崩溃。',
  I18nKeys.faultScenarioZoneCrashTitle: 'Zone 异步未捕获异常与落盘',
  I18nKeys.faultScenarioZoneCrashDesc: '在当前 Dart Zone 注入未捕获异步异常。验证 ZoneManager 与 CrashManager 自动捕获落盘并绑定 Trace ID。',
  I18nKeys.faultScenarioSafeModeTitle: '连续崩溃触发 Safe Mode 安全模式',
  I18nKeys.faultScenarioSafeModeDesc: '模拟 30 秒内连续触发 3 次致命异常。验证 CrashManager 自动激活 Safe Mode 熔断与自愈重置机制。',
  I18nKeys.faultScenarioJankTitle: '主线程阻塞 (Jank) 与 APM 告警',
  ...
  I18nKeys.referralUtmSourceLabel: 'UTM 渠道',
  I18nKeys.referralUtmMediumLabel: 'UTM 媒介',
  I18nKeys.referralUtmCampaignLabel: 'UTM 活动',
  I18nKeys.referralUtmContentLabel: 'UTM 内容',
  I18nKeys.referralUtmTermLabel: 'UTM 关键词',
