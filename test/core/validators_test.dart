...
import 'package:listen_portfolio_flutter/core/utils/validators.dart';
  ...
  group('Validators', () {
    ...
    group('validateEmail', () {
      ...
      test('returns requiredMsg when value is null', () {
        expect(
          Validators.validateEmail(null, requiredMsg: required, invalidMsg: invalid),
          required,
        );
      });
      ...
      test('returns requiredMsg when value is empty', () {
        expect(
          Validators.validateEmail('', requiredMsg: required, invalidMsg: invalid),
          required,
        );
      });
      ...
      test('returns invalidMsg for plain string without @', () {
        expect(
          Validators.validateEmail('notanemail', requiredMsg: required, invalidMsg: invalid),
          invalid,
        );
      });
      ...
      test('returns invalidMsg for missing domain', () {
        expect(
          Validators.validateEmail('user@', requiredMsg: required, invalidMsg: invalid),
          invalid,
        );
      });
      ...
      test('returns invalidMsg for missing TLD', () {
        expect(
          Validators.validateEmail('user@domain', requiredMsg: required, invalidMsg: invalid),
          invalid,
        );
      });
    ...
    group('validatePassword', () {
      ...
      test('returns requiredMsg when value is null', () {
        expect(
          Validators.validatePassword(null, requiredMsg: required, minLengthMsg: tooShort),
          required,
        );
      });
      ...
      test('returns requiredMsg when value is empty', () {
        expect(
          Validators.validatePassword('', requiredMsg: required, minLengthMsg: tooShort),
          required,
        );
      });
      ...
      test('returns minLengthMsg when password shorter than 6 chars', () {
        expect(
          Validators.validatePassword('abc', requiredMsg: required, minLengthMsg: tooShort),
          tooShort,
        );
      });
      ...
      test('returns minLengthMsg for exactly 5 chars', () {
        expect(
          Validators.validatePassword('abcde', requiredMsg: required, minLengthMsg: tooShort),
          tooShort,
        );
      });
      ...
      test('returns null for exactly 6 chars (boundary)', () {
        expect(
          Validators.validatePassword('abcdef', requiredMsg: required, minLengthMsg: tooShort),
          isNull,
        );
      });
    ...
    group('validateUsername', () {
      ...
      test('returns requiredMsg when value is null', () {
        expect(
          Validators.validateUsername(null, requiredMsg: required, minLengthMsg: tooShort),
          required,
        );
      });
      ...
      test('returns requiredMsg when value is empty', () {
        expect(
          Validators.validateUsername('', requiredMsg: required, minLengthMsg: tooShort),
          required,
        );
      });
      ...
      test('returns minLengthMsg for 1-char username', () {
        expect(
          Validators.validateUsername('a', requiredMsg: required, minLengthMsg: tooShort),
          tooShort,
        );
      });
      ...
      test('returns minLengthMsg for exactly 2 chars', () {
        expect(
          Validators.validateUsername('ab', requiredMsg: required, minLengthMsg: tooShort),
          tooShort,
        );
      });
      ...
      test('returns null for exactly 3 chars (boundary)', () {
        expect(
          Validators.validateUsername('abc', requiredMsg: required, minLengthMsg: tooShort),
          isNull,
        );
      });
    ...
    group('validatePasswordConfirmation', () {
      ...
      test('returns requiredMsg when confirmation is null', () {
        expect(
          Validators.validatePasswordConfirmation('pass123', null,
              requiredMsg: required, mismatchMsg: mismatch),
          required,
        );
      });
      ...
      test('returns mismatchMsg when original password is null but confirmation has value', () {
        expect(
          Validators.validatePasswordConfirmation(null, 'pass123',
              requiredMsg: required, mismatchMsg: mismatch),
          mismatch,
        );
      });
